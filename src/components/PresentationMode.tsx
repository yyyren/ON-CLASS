          ...
          (decodedText) => {
            ...
            try {
              ...
              if (decodedText.includes("mode=apresentacao_aluno")) {
                ...
                if (roomParam) {
                  alert(`Você escaneou o QR Code do Cadastro (Passo 1).\nPor favor, aponte para o QR Code de Validação (Passo 2) com o código de 30 segundos!`);
                  return;
                }
              }
            } catch (e) {}
    ...
    <div className="w-full min-h-screen bg-[#f3f7fd] flex flex-col">
      ...
      {role === 'presenter' && (
        <main className="flex-1 max-w-7xl mx-auto w-full p-4 md:p-6 grid grid-cols-1 lg:grid-cols-5 gap-6">
          ...
          <div className="col-span-1 lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-5 border border-slate-200/80 shadow-sm relative overflow-hidden flex flex-col items-center text-center space-y-4">
              ...
              <div className="pt-2">
                ...
                <p className="text-[10px] text-slate-500">Este QR Code muda automaticamente de 30 em 30 segundos!</p>
              </div>
                ...
                <div className="absolute -top-3 -right-3 bg-white w-10 h-10 rounded-full shadow-md border border-slate-100 flex items-center justify-center">
                  <svg className="w-8 h-8 transform -rotate-95">
                    ...
                    <circle
                      ...
                      strokeDashoffset={(timeLeftMs / 30000) * 75.3}
                    />
                  </svg>
          ...
          {/* MAIN CENTER: LIVE SHEET LIST (Now filling the remaining space instead of slides) */}
          <div className="col-span-1 lg:col-span-3 space-y-6">
            
            {/* LIVE SPREADSHEET SHEET OF COMPLETED DISPOSITIVES */}
            <div className="bg-white rounded-3xl border border-slate-200/85 p-6 shadow-sm space-y-4 h-full">
              ...
              <div className="border border-slate-200 rounded-2xl overflow-hidden shadow-inner max-h-[800px] overflow-y-auto">
                {attendances.length === 0 ? (
                  <div className="p-12 text-center flex flex-col items-center justify-center bg-slate-50/50 min-h-[400px]">
                    ...
                    <p className="text-[10px] text-slate-400 max-w-[280px] leading-relaxed mt-1">
                      Peça para os alunos apontarem para o <strong className="text-blue-500">QR Code 2</strong> rotativo (agora com 30s) após inserirem o nome completo!
                    </p>
                  </div>
                ) : (
            ...
            <div className="bg-white rounded-3xl border border-slate-200/80 shadow-lg p-6 space-y-6">
              ...
              <div className="border-t border-slate-100 pt-5 space-y-3">
                <div className="text-center">
                  ...
                  <p className="text-[9px] text-slate-400">Insira a chave de 4 letras no telão (atualizada a cada 30s):</p>
                </div>
